...
A path outside the scope is not a dead end at level 1: the approval
screen offers its directory for the session, or the path alone for that one
job, and the person at the terminal decides. See
